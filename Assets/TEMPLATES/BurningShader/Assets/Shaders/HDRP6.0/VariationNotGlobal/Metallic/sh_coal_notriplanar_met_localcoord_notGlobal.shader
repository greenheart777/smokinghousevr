...
Shader "BurnedHDRP/NotGlobal/Coal_NoTriplanar_Met_LocalCoord"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				half3 lerpResult93 = lerp( BlendNormal( UnpackNormalScale( tex2D( _DetailWoodNormal, ( texCoord262 * 5.0 ) ), 1.0f ) , UnpackNormalScale( tex2D( _WoodNormal, uv_WoodNormal ), 1.0f ) ) , UnpackNormalScale( tex2D( _CoalNormal, temp_output_45_0 ), 1.0f ) , clampResult43);
...
/*ASEBEGIN
Version=18500
-1914;6;1907;1013;6329.951;708.4046;3.330725;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;178;-3005.34,1289.125;Float;False;Property;_CinderLow;CinderLow;12;0;Create;True;0;0;False;0;False;0.18;1.96;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;157;-2777.392,969.3057;Float;False;Property;_CinderSidePower;CinderSidePower;11;0;Create;True;0;0;False;0;False;1.55;0.15;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;239;163.4688,200.0336;Inherit;True;Property;_WoodAoMet_AOR_MetG;WoodAoMet_AO(R)_Met(G);18;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=29DD98A5FDFF5F63A0E8878B4E2658E448CDF438