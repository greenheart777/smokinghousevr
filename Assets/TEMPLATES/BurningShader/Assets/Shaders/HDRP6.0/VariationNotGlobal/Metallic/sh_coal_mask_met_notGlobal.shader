...
Shader "BurnedHDRP/NotGlobal/Coal_Mask_Met"
{
	Properties
	{
		...
		[ASEEnd]_WoodAoMet_AOR_MetG("WoodAoMet_AO(R)_Met(G)", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 temp_output_45_0 = ( packedInput.ase_texcoord5.xy * _UVTiling );
				float4 tex2DNode24 = tex2D( _CoalMasks, temp_output_45_0 );
				float CoalColor205 = tex2DNode24.r;
				float3 temp_cast_2 = (CoalColor205).xxx;
				float4 transform117 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_normal , 0.0 ));
				transform117.xyz = GetAbsolutePositionWS((transform117).xyz);
				float4 transform152 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_texcoord6.xyz , 0.0 ));
				transform152.xyz = GetAbsolutePositionWS((transform152).xyz);
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, ase_worldPos, normalWS, 1.0, _TriplanarScale, 1.0, 0 );
				float2 temp_cast_5 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord5.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				float2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * packedInput.ase_texcoord5.xy ) , temp_cast_5 , 0.01);
				...
				float2 texCoord262 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float3 lerpResult93 = lerp( BlendNormal( UnpackNormalScale( tex2D( _DetailWoodNormal, ( texCoord262 * 5.0 ) ), 1.0f ) , UnpackNormalScale( tex2D( _WoodNormal, uv_WoodNormal ), 1.0f ) ) , UnpackNormalScale( tex2D( _CoalNormal, temp_output_45_0 ), 1.0f ) , clampResult43);
				
				float2 temp_cast_6 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord5.xy * 2.0 ) ).g * _CoalNoiseScale )).xx;
				...
				float4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				...
				float2 uv_WoodAoMet_AOR_MetG = packedInput.ase_texcoord5.xy * _WoodAoMet_AOR_MetG_ST.xy + _WoodAoMet_AOR_MetG_ST.zw;
				float CoalNoise2206 = tex2DNode24.b;
				float lerpResult238 = lerp( tex2D( _WoodAoMet_AOR_MetG, uv_WoodAoMet_AOR_MetG ).r , ( temp_output_123_0 * ( 1.0 - ( CoalNoise2206 + clampResult180 ) ) ) , FirePower224);
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float3 appendResult16_g1 = (float3(temp_output_18_0_g1 , temp_output_18_0_g1 , temp_output_18_0_g1));
				float FirePower224 = _StartBurning;
				float2 temp_output_45_0 = ( packedInput.ase_texcoord.xy * _UVTiling );
				float4 tex2DNode24 = tex2D( _CoalMasks, temp_output_45_0 );
				float CoalColor205 = tex2DNode24.r;
				float3 temp_cast_2 = (CoalColor205).xxx;
				float4 transform117 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_normal , 0.0 ));
				transform117.xyz = GetAbsolutePositionWS((transform117).xyz);
				float4 transform152 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_texcoord1.xyz , 0.0 ));
				transform152.xyz = GetAbsolutePositionWS((transform152).xyz);
				...
				float2 temp_cast_5 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				float2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * packedInput.ase_texcoord.xy ) , temp_cast_5 , 0.01);
				float4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				float clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				float clampResult155 = clamp( ( max( transform117.y , 0.0 ) + ( max( transform152.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				float temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (_StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
				...
				float2 texCoord262 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 temp_cast_6 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord.xy * 2.0 ) ).g * _CoalNoiseScale )).xx;
				float2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_6);
				float clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				float4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				float clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
				...
				float2 uv_WoodAoMet_AOR_MetG = packedInput.ase_texcoord.xy * _WoodAoMet_AOR_MetG_ST.xy + _WoodAoMet_AOR_MetG_ST.zw;
				float CoalNoise2206 = tex2DNode24.b;
				float lerpResult238 = lerp( tex2D( _WoodAoMet_AOR_MetG, uv_WoodAoMet_AOR_MetG ).r , ( temp_output_123_0 * ( 1.0 - ( CoalNoise2206 + clampResult180 ) ) ) , FirePower224);
		...
		Pass
		{
					...
					)
			{
				...
				float2 temp_output_45_0 = ( packedInput.ase_texcoord3.xy * _UVTiling );
		...
		Pass
		{
						...
						)
			{
				...
				float3 appendResult16_g1 = (float3(temp_output_18_0_g1 , temp_output_18_0_g1 , temp_output_18_0_g1));
				float FirePower224 = _StartBurning;
				float2 temp_output_45_0 = ( packedInput.ase_texcoord7.xy * _UVTiling );
				float4 tex2DNode24 = tex2D( _CoalMasks, temp_output_45_0 );
				float CoalColor205 = tex2DNode24.r;
				float3 temp_cast_2 = (CoalColor205).xxx;
				float4 transform117 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_normal , 0.0 ));
				transform117.xyz = GetAbsolutePositionWS((transform117).xyz);
				float4 transform152 = mul(GetObjectToWorldMatrix(),float4( packedInput.ase_texcoord8.xyz , 0.0 ));
				transform152.xyz = GetAbsolutePositionWS((transform152).xyz);
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, ase_worldPos, normalWS, 1.0, _TriplanarScale, 1.0, 0 );
				float2 temp_cast_5 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord7.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				float2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * packedInput.ase_texcoord7.xy ) , temp_cast_5 , 0.01);
				float4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				float clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				float clampResult155 = clamp( ( max( transform117.y , 0.0 ) + ( max( transform152.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				float temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (_StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
				...
				float2 temp_cast_6 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord7.xy * 2.0 ) ).g * _CoalNoiseScale )).xx;
				float2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_6);
				float clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				float4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				float clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
				...
				float2 uv_WoodAoMet_AOR_MetG = packedInput.ase_texcoord7.xy * _WoodAoMet_AOR_MetG_ST.xy + _WoodAoMet_AOR_MetG_ST.zw;
				float CoalNoise2206 = tex2DNode24.b;
				float lerpResult238 = lerp( tex2D( _WoodAoMet_AOR_MetG, uv_WoodAoMet_AOR_MetG ).r , ( temp_output_123_0 * ( 1.0 - ( CoalNoise2206 + clampResult180 ) ) ) , FirePower224);
...
/*ASEBEGIN
Version=18500
-1914;6;1907;1013;4643.477;784.2723;2.464719;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;296;-4494.289,1054.009;Float;False;Property;_TriplanarScale;TriplanarScale;22;0;Create;True;0;0;False;0;False;0.2;0.28;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;236;-2970.067,-460.4288;Float;False;Property;_UVTiling;UVTiling;15;0;Create;True;0;0;False;0;False;1,1;3,3;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;29;-3149.637,1446.938;Inherit;True;Property;_TextureSample2;Texture Sample 2;4;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;33;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;178;-3005.34,1289.125;Float;False;Property;_CinderLow;CinderLow;13;0;Create;True;0;0;False;0;False;0.18;-0.29;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;218;-2498.403,-106.1524;Float;False;Property;_StartBurning;StartBurning;21;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;157;-2777.392,969.3057;Float;False;Property;_CinderSidePower;CinderSidePower;11;0;Create;True;0;0;False;0;False;1.55;1.49;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;22;-2965.419,161.6456;Inherit;True;Property;_TextureSample0;Texture Sample 0;4;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;33;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;18;-2899.988,371.2204;Float;False;Property;_CoalNoiseScale;CoalNoiseScale;9;0;Create;True;0;0;False;0;False;0.5;0.58;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-3239.084,1718.399;Float;False;Property;_StopBurning;StopBurning;12;0;Create;True;0;0;False;0;False;0.5;0.5;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;309;-4239.369,828.2676;Float;False;Property;_MaskPower;MaskPower;20;0;Create;True;0;0;False;0;False;3.5;3.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;33;-1909.745,-306.4492;Inherit;True;Property;_CoalMasks;CoalMasks;4;0;Create;True;0;0;False;0;False;-1;None;2d479324bd85dcd4facb271ae1f53661;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-1974.856,928.1199;Float;False;Property;_CinderPower;CinderPower;10;0;Create;True;0;0;False;0;False;2;0.13;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TFHCRemapNode;219;-1854.443,-94.40897;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;0;False;4;FLOAT;2;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;9;-1962.441,184.8739;Inherit;True;Property;_rew;rew;4;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Instance;33;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;100;-1869.718,381.0922;Float;False;Constant;_CoalNoisePower;CoalNoisePower;11;0;Create;True;0;0;False;0;False;33;33;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;196;-1075.165,408.9827;Float;False;Property;_AshesPower;AshesPower;14;0;Create;True;0;0;False;0;False;3.6;3.64;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;255;-67.6104,-440.0819;Inherit;True;Property;_DetailWoodAlbedo;DetailWoodAlbedo;16;0;Create;True;0;0;False;0;False;-1;None;37cc52a2055f6934dad950c330a3ac79;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;256;-1060.625,-985.342;Inherit;True;Property;_DetailWoodNormal;DetailWoodNormal;19;0;Create;True;0;0;False;0;False;-1;None;1dd0ff673f5f4fd4ba9643118392cce0;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.ColorNode;48;-1456.608,57.06815;Float;False;Property;_CoalColor;CoalColor;8;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;7.906699,2.607969,1.366079,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.GetLocalVarNode;225;-858.2903,658.899;Inherit;False;224;FirePower;1;0;OBJECT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;10;-67.9334,-631.02;Inherit;True;Property;_WoodAlbedo;WoodAlbedo;5;0;Create;True;0;0;False;0;False;-1;None;23f9b61e82d1a484e8d09394b298c3f9;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;11;-1170.334,-735.5777;Inherit;True;Property;_WoodNormal;WoodNormal;6;0;Create;True;0;0;False;0;False;-1;None;dda9654122c08ad4ebc1d2c4aef2224e;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;330;-1340.191,379.2905;Inherit;False;Constant;_Float0;Float 0;20;0;Create;True;0;0;False;0;False;3000;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.FunctionNode;244;372.9306,-456.509;Inherit;False;Detail Albedo;0;;1;29e5a290b15a7884983e27c8f1afaa8c;0;3;12;FLOAT3;0,0,0;False;11;FLOAT3;0,0,0;False;9;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.SamplerNode;13;-1168.178,-510.9188;Inherit;True;Property;_CoalNormal;CoalNormal;7;0;Create;True;0;0;False;0;False;-1;None;f91c76d43b07b034ba951400ad8c3133;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StepOpNode;331;970.9224,-552.0702;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;239;234.8386,226.3186;Inherit;True;Property;_WoodAoMet_AOR_MetG;WoodAoMet_AO(R)_Met(G);23;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WireNode;328;395.0318,-26.01039;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.OneMinusNode;332;1157.741,-550.8116;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;320;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;DepthOnly;0;4;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-6;255;False;-1;255;True;-7;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;326;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Forward;0;10;Forward;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;True;0;True;-28;False;True;True;True;True;True;0;True;-44;False;False;True;True;0;True;-4;255;False;-1;255;True;-5;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;0;True;-23;True;0;True;-30;False;True;1;LightMode=Forward;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;321;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-8;255;False;-1;255;True;-9;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;319;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;323;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentBackface;0;7;TransparentBackface;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;True;1;False;-1;False;True;True;True;True;True;0;True;-44;False;False;False;True;0;True;-23;True;0;True;-31;False;True;1;LightMode=TransparentBackface;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;317;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;META;0;1;META;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;316;1413.548,74.58441;Half;False;True;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;BurnedHDRP/NotGlobal/Coal_Mask_Met;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=TransparentCutout=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-22;False;False;False;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-25;False;True;1;LightMode=GBuffer;False;0;;0;0;Standard;41;Surface Type;0;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;0;Alpha Clipping;1;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;0;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;Motion Vectors;1;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;1;Override Baked GI;0;Depth Offset;0;DOTS Instancing;0;LOD CrossFade;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;1;0;11;True;True;True;True;True;True;False;False;False;False;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;324;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPrepass;0;8;TransparentDepthPrepass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPrepass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;325;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPostpass;0;9;TransparentDepthPostpass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPostpass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;322;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Distortion;0;6;Distortion;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;4;1;False;-1;1;False;-1;1;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;True;0;True;-10;255;False;-1;255;True;-11;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;318;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;;0;0;Standard;0;False;0
...
WireConnection;316;0;306;0
WireConnection;316;1;328;0
WireConnection;316;6;87;0
WireConnection;316;7;228;0
WireConnection;316;8;238;0
WireConnection;316;9;332;0
ASEEND*/
//CHKSM=0CDD6E40006F82A9E4A6BAECC7DD7E118BF2D8D6