...
Shader "BurnedHDRP/NotGlobal/Coal_Mask_LocalCoord"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 temp_cast_3 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord5.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				float2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * packedInput.ase_texcoord5.xy ) , temp_cast_3 , 0.01);
				...
				float clampResult155 = clamp( ( max( packedInput.ase_normal.y , 0.0 ) + ( max( packedInput.ase_texcoord6.xyz.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				...
				float4 lerpResult270 = lerp( _Specular , temp_cast_4 , FirePower224);
				
				float2 temp_cast_6 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord5.xy * 2.0 ) ).g * 0.5 )).xx;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 temp_cast_3 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				float2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * packedInput.ase_texcoord.xy ) , temp_cast_3 , 0.01);
				float4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				float clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				float clampResult155 = clamp( ( max( packedInput.ase_normal.y , 0.0 ) + ( max( packedInput.ase_texcoord1.xyz.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				float temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (_StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
				float clampResult192 = clamp( ( pow( CoalColor205 , _AshesPower ) * (0.0 + (temp_output_91_0 - 0.9) * (1.0 - 0.0) / (1.0 - 0.9)) * FirePower224 ) , 0.0 , 1.0 );
				float3 lerpResult306 = lerp( ( ( tex2DNode10.rgb * ( ( ( tex2D( _DetailWoodAlbedo, uv_DetailWoodAlbedo ).rgb * (unity_ColorSpaceDouble).rgb ) * temp_output_9_0_g1 ) + appendResult16_g1 ) ) * (0.77 + (FirePower224 - 0.0) * (0.0 - 0.77) / (1.0 - 0.0)) ) , temp_cast_2 , clampResult192);
				...
				float2 temp_cast_6 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord.xy * 2.0 ) ).g * 0.5 )).xx;
				float2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_6);
				float clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				float4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				float clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
		...
		Pass
		{
						...
						)
			{
				...
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, ase_worldPos, normalWS, 1.0, _TriplanarScale, 1.0, 0 );
				float2 temp_cast_3 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord7.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				float2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * packedInput.ase_texcoord7.xy ) , temp_cast_3 , 0.01);
				float4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				float clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				float clampResult155 = clamp( ( max( packedInput.ase_normal.y , 0.0 ) + ( max( packedInput.ase_texcoord8.xyz.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				float temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (_StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
				float clampResult192 = clamp( ( pow( CoalColor205 , _AshesPower ) * (0.0 + (temp_output_91_0 - 0.9) * (1.0 - 0.0) / (1.0 - 0.9)) * FirePower224 ) , 0.0 , 1.0 );
				float3 lerpResult306 = lerp( ( ( tex2DNode10.rgb * ( ( ( tex2D( _DetailWoodAlbedo, uv_DetailWoodAlbedo ).rgb * (unity_ColorSpaceDouble).rgb ) * temp_output_9_0_g1 ) + appendResult16_g1 ) ) * (0.77 + (FirePower224 - 0.0) * (0.0 - 0.77) / (1.0 - 0.0)) ) , temp_cast_2 , clampResult192);
				...
				float2 temp_cast_6 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord7.xy * 2.0 ) ).g * 0.5 )).xx;
				float2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_6);
				float clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				float4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				float clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18500
-1914;6;1907;1013;5135.957;1103.127;3.589745;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;296;-4494.289,1054.009;Float;False;Property;_TriplanarScale;TriplanarScale;22;0;Create;True;0;0;False;0;False;0.2;1.6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;157;-2777.392,969.3057;Float;False;Property;_CinderSidePower;CinderSidePower;10;0;Create;True;0;0;False;0;False;1.55;1.66;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-1974.856,928.1199;Float;False;Property;_CinderPower;CinderPower;9;0;Create;True;0;0;False;0;False;2;0.65;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;48;-1456.608,57.06815;Float;False;Property;_CoalColor;CoalColor;8;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;6.883182,2.270369,1.189241,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;11;-1170.334,-735.5777;Inherit;True;Property;_WoodNormal;WoodNormal;6;0;Create;True;0;0;False;0;False;-1;None;596b33ebc0887e74f8a8eb312c28ca7e;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;10;-67.9334,-631.02;Inherit;True;Property;_WoodAlbedo;WoodAlbedo;5;0;Create;True;0;0;False;0;False;-1;None;d63235a1baa078547836de0f1163621a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;239;-204.4312,622.5336;Inherit;True;Property;_WoodOcclusion_AOR;WoodOcclusion_AO(R);23;0;Create;True;0;0;False;0;False;-1;None;cda04cf139859604badb70af62700f4b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=78DBE0AF1874C7B5B248B1D55DB91BB334A7A2A0