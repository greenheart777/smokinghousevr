...
Shader "BurnedHDRP/Coal_NoTriplanar_NoDetailAlbedo"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 lerpResult175 = lerp( packedInput.ase_texcoord5.xy , temp_cast_3 , 0.01);
				...
				float3 lerpResult93 = lerp( UnpackNormalmapRGorAG( tex2D( _WoodNormal, uv_WoodNormal ), 1.0f ) , UnpackNormalmapRGorAG( tex2D( _CoalNormal, temp_output_45_0 ), 1.0f ) , clampResult43);
				
				float4 temp_cast_5 = (0.0).xxxx;
				float4 lerpResult270 = lerp( _Specular , temp_cast_5 , FirePower224);
				
				float2 temp_cast_7 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord5.xy * 2.0 ) ).g * 0.5 )).xx;
				float2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_7);
				...
				surfaceDescription.Albedo = lerpResult306.rgb;
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 lerpResult175 = lerp( packedInput.ase_texcoord.xy , temp_cast_3 , 0.01);
				float4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				float clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				float clampResult155 = clamp( ( max( transform117.y , 0.0 ) + ( max( transform152.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				float temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
				...
				float2 temp_cast_7 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord.xy * 2.0 ) ).g * 0.5 )).xx;
				float2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_7);
				float clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				float4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				float clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
		...
		Pass
		{
						...
						)
			{
				...
				float2 lerpResult175 = lerp( packedInput.ase_texcoord7.xy , temp_cast_3 , 0.01);
				float4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				float clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				float clampResult155 = clamp( ( max( transform117.y , 0.0 ) + ( max( transform152.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				float temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
				...
				float2 temp_cast_7 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord7.xy * 2.0 ) ).g * 0.5 )).xx;
				float2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_7);
				float clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				float4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				float clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18500
249;32;1502;646;2198.779;-0.7368317;1;True;False
...
Node;AmplifyShaderEditor.Vector2Node;236;-2970.067,-460.4288;Float;False;Property;_UVTiling;UVTiling;9;0;Create;True;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;178;-3005.34,1289.125;Float;False;Property;_CinderLow;CinderLow;7;0;Create;True;0;0;False;0;False;0.18;1.96;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;157;-2777.392,969.3057;Float;False;Property;_CinderSidePower;CinderSidePower;6;0;Create;True;0;0;False;0;False;1.55;0.15;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-1974.856,928.1199;Float;False;Property;_CinderPower;CinderPower;5;0;Create;True;0;0;False;0;False;2;0.32;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;196;-1075.165,408.9827;Float;False;Property;_AshesPower;AshesPower;8;0;Create;True;0;0;False;0;False;3.6;3.64;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;48;-1456.608,57.06815;Float;False;Property;_CoalColor;CoalColor;4;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;7.906699,2.607969,1.366079,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;323;-1350.779,392.7368;Inherit;False;Constant;_Float2;Float 0;20;0;Create;True;0;0;False;0;False;3000;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;11;-1170.334,-735.5777;Inherit;True;Property;_WoodNormal;WoodNormal;2;0;Create;True;0;0;False;0;False;-1;None;f56e8c73d755f2347b44412fc6ad9b0f;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;10;-176.3099,-605.78;Inherit;True;Property;_WoodAlbedo;WoodAlbedo;1;0;Create;True;0;0;False;0;False;-1;None;518249a30c8ae754ba6ace7438dae717;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;239;-204.4312,622.5336;Inherit;True;Property;_WoodOcclusion_AOR;WoodOcclusion_AO(R);12;0;Create;True;0;0;False;0;False;-1;None;8cba82c5350f91d46ad8e6539ff3c81f;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-62.15375,384.0183;Float;False;Property;_WoodSm;WoodSm;11;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;321;678.7021,134.878;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;322;433.7021,42.87796;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=BBCA9BDB9D20A830308502D313330534B51BE201