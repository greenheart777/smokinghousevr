...
Shader "BurnedHDRP/Coal_NoDetailAlbedo_LocalCoord"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				half2 temp_cast_1 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord5.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				half2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * packedInput.ase_texcoord5.xy ) , temp_cast_1 , 0.01);
				...
				half4 temp_cast_3 = (0.0).xxxx;
				half4 lerpResult270 = lerp( _Specular , temp_cast_3 , FirePower224);
				
				half2 temp_cast_5 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord5.xy * 2.0 ) ).g * 0.5 )).xx;
				half2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_5);
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half2 temp_cast_1 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				half2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * packedInput.ase_texcoord.xy ) , temp_cast_1 , 0.01);
				half4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				half clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				...
				half2 temp_cast_5 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord.xy * 2.0 ) ).g * 0.5 )).xx;
				half2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_5);
				half clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				half4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				half clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
		...
		Pass
		{
						...
						)
			{
				...
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, ase_worldPos, normalWS, 1.0, _TriplanarScale, 1.0, 0 );
				half2 temp_cast_1 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord7.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				half2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * packedInput.ase_texcoord7.xy ) , temp_cast_1 , 0.01);
				half4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				half clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				...
				half2 temp_cast_5 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord7.xy * 2.0 ) ).g * 0.5 )).xx;
				half2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_5);
				half clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				half4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				half clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18500
249;32;1502;646;1143.817;782.5955;2.14784;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;309;-1356.558,383.5091;Inherit;False;Constant;_Float2;Float 0;20;0;Create;True;0;0;False;0;False;3000;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;321;244.3541,-22.83795;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WireNode;322;671.3541,146.162;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
ASEEND*/
//CHKSM=C0AC49F15D776B043E869774BA74764DB71B4C76