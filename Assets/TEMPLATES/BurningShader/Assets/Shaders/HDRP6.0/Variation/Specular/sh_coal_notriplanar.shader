...
Shader "BurnedHDRP/Coal_NoTriplanar"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				float2 lerpResult175 = lerp( packedInput.ase_texcoord5.xy , temp_cast_5 , 0.01);
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				float2 lerpResult175 = lerp( packedInput.ase_texcoord.xy , temp_cast_5 , 0.01);
				float4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				float clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				float clampResult155 = clamp( ( max( transform117.y , 0.0 ) + ( max( transform152.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				float temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
		...
		Pass
		{
						...
						)
			{
				...
				float2 lerpResult175 = lerp( packedInput.ase_texcoord7.xy , temp_cast_5 , 0.01);
				float4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				float clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				float clampResult155 = clamp( ( max( transform117.y , 0.0 ) + ( max( transform152.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				float temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
...
/*ASEBEGIN
Version=18500
249;32;1502;646;3263.251;344.3303;2.339642;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;323;-1363.721,390.9975;Inherit;False;Constant;_Float2;Float 0;20;0;Create;True;0;0;False;0;False;3000;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;322;730.1184,159.5836;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.WireNode;321;263.5882,-16.83537;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;310;6;322;0
WireConnection;310;7;228;0
WireConnection;310;8;238;0
ASEEND*/
//CHKSM=DF5B67C3FF4419CD34342B022F9925AD9833916E