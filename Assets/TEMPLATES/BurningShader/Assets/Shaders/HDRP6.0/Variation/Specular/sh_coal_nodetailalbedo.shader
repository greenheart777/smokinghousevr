...
Shader "BurnedHDRP/Coal_NoDetailAlbedo"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				half4 lerpResult306 = lerp( ( tex2D( _WoodAlbedo, uv_WoodAlbedo ) * (0.77 + (FirePower224 - 0.0) * (0.0 - 0.77) / (1.0 - 0.0)) ) , temp_cast_0 , clampResult192);
				...
				half3 lerpResult93 = lerp( UnpackNormalmapRGorAG( tex2D( _WoodNormal, uv_WoodNormal ), 1.0f ) , UnpackNormalmapRGorAG( tex2D( _CoalNormal, temp_output_45_0 ), 1.0f ) , clampResult43);
				
				half4 temp_cast_5 = (0.0).xxxx;
				half4 lerpResult270 = lerp( _Specular , temp_cast_5 , FirePower224);
				
				half2 temp_cast_7 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord5.xy * 2.0 ) ).g * 0.5 )).xx;
				half2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_7);
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half2 temp_cast_7 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord.xy * 2.0 ) ).g * 0.5 )).xx;
				half2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_7);
				half clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				half4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				half clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
		...
		Pass
		{
						...
						)
			{
				...
				half2 temp_cast_7 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord7.xy * 2.0 ) ).g * 0.5 )).xx;
				half2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_7);
				half clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				half4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				half clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18500
249;32;1502;646;2159.397;-15.59528;1.008809;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;322;-1359.412,403.9866;Inherit;False;Constant;_Float2;Float 0;20;0;Create;True;0;0;False;0;False;3000;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;239;-204.4312,622.5336;Inherit;True;Property;_WoodOcclusion_AOR;WoodOcclusion_AO(R);14;0;Create;True;0;0;False;0;False;-1;None;cda04cf139859604badb70af62700f4b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WireNode;320;640.7496,123.4923;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
Node;AmplifyShaderEditor.WireNode;321;249.3065,-17.99548;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;309;1;321;0
WireConnection;309;5;270;0
WireConnection;309;6;320;0
WireConnection;309;7;228;0
WireConnection;309;8;238;0
ASEEND*/
//CHKSM=A26426F4FD282674DB0046EA15580683C4AE48FF