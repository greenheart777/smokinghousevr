...
Shader "BurnedHDRP/Coal_Mask_LocalCoord"
{
	Properties
	{
		...
		_MaskPower("MaskPower", Float) = 3.5
		_TriplanarScale("TriplanarScale", Float) = 0.2
		[ASEEnd]_WoodOcclusion_AOR("WoodOcclusion_AO(R)", 2D) = "white" {}
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 _DetailWoodAlbedo_ST;
			half4 _WoodNormal_ST;
			half4 _CoalMasks_ST;
			float4 _Specular;
			float4 _CoalColor;
			half4 _WoodOcclusion_AOR_ST;
			float2 _UVTiling;
			float _AshesPower;
						...
						)
			{
				...
				float2 uv_WoodAlbedo = packedInput.ase_texcoord5.xy * _WoodAlbedo_ST.xy + _WoodAlbedo_ST.zw;
				half4 tex2DNode10 = tex2D( _WoodAlbedo, uv_WoodAlbedo );
				float2 uv_DetailWoodAlbedo = packedInput.ase_texcoord5.xy * _DetailWoodAlbedo_ST.xy + _DetailWoodAlbedo_ST.zw;
				half temp_output_9_0_g1 = tex2DNode10.r;
				half temp_output_18_0_g1 = ( 1.0 - temp_output_9_0_g1 );
				half3 appendResult16_g1 = (half3(temp_output_18_0_g1 , temp_output_18_0_g1 , temp_output_18_0_g1));
				float FirePower224 = StartBurning;
				half2 temp_output_45_0 = ( packedInput.ase_texcoord5.xy * _UVTiling );
				half4 tex2DNode24 = tex2D( _CoalMasks, temp_output_45_0 );
				float CoalColor205 = tex2DNode24.r;
				half3 temp_cast_2 = (CoalColor205).xxx;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, ase_worldPos, normalWS, 1.0, _TriplanarScale, 1.0, 0 );
				half2 temp_cast_3 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord5.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				half2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * packedInput.ase_texcoord5.xy ) , temp_cast_3 , 0.01);
				half4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				half clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				half clampResult155 = clamp( ( max( packedInput.ase_normal.y , 0.0 ) + ( max( packedInput.ase_texcoord6.xyz.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				half temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
				half clampResult192 = clamp( ( pow( CoalColor205 , _AshesPower ) * (0.0 + (temp_output_91_0 - 0.9) * (1.0 - 0.0) / (1.0 - 0.9)) * FirePower224 ) , 0.0 , 1.0 );
				half3 lerpResult306 = lerp( ( ( tex2DNode10.rgb * ( ( ( tex2D( _DetailWoodAlbedo, uv_DetailWoodAlbedo ).rgb * (unity_ColorSpaceDouble).rgb ) * temp_output_9_0_g1 ) + appendResult16_g1 ) ) * (0.77 + (FirePower224 - 0.0) * (0.0 - 0.77) / (1.0 - 0.0)) ) , temp_cast_2 , clampResult192);
				
				half2 texCoord262 = packedInput.ase_texcoord5.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv_WoodNormal = packedInput.ase_texcoord5.xy * _WoodNormal_ST.xy + _WoodNormal_ST.zw;
				float2 uv_CoalMasks = packedInput.ase_texcoord5.xy * _CoalMasks_ST.xy + _CoalMasks_ST.zw;
				half clampResult43 = clamp( ( 1.0 - pow( tex2D( _CoalMasks, uv_CoalMasks ).b , (0.0 + (StartBurning - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) ) , 0.0 , 1.0 );
				half3 lerpResult93 = lerp( BlendNormal( UnpackNormalmapRGorAG( tex2D( _DetailWoodNormal, ( texCoord262 * 5.0 ) ), 1.0f ) , UnpackNormalmapRGorAG( tex2D( _WoodNormal, uv_WoodNormal ), 1.0f ) ) , UnpackNormalmapRGorAG( tex2D( _CoalNormal, temp_output_45_0 ), 1.0f ) , clampResult43);
				
				half4 temp_cast_4 = (0.0).xxxx;
				half4 lerpResult270 = lerp( _Specular , temp_cast_4 , FirePower224);
				
				half2 temp_cast_6 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord5.xy * 2.0 ) ).g * 0.5 )).xx;
				half2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_6);
				half clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				half4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				...
				half lerpResult228 = lerp( _WoodSm , CoalSmAo207 , FirePower224);
				
				float2 uv_WoodOcclusion_AOR = packedInput.ase_texcoord5.xy * _WoodOcclusion_AOR_ST.xy + _WoodOcclusion_AOR_ST.zw;
				float CoalNoise2206 = tex2DNode24.b;
				half lerpResult238 = lerp( tex2D( _WoodOcclusion_AOR, uv_WoodOcclusion_AOR ).r , ( temp_output_123_0 * ( 1.0 - ( CoalNoise2206 + clampResult180 ) ) ) , FirePower224);
				
				float BurnedMask314 = ( (20.0 + (FirePower224 - 0.0) * (_MaskPower - 20.0) / (1.0 - 0.0)) * triplanar294.x );
				
				surfaceDescription.Albedo = lerpResult306;
				surfaceDescription.Normal = lerpResult93;
				surfaceDescription.BentNormal = float3( 0, 0, 1 );
				surfaceDescription.CoatMask = 0;
				surfaceDescription.Metallic = 0;

				#ifdef _MATERIAL_FEATURE_SPECULAR_COLOR
				surfaceDescription.Specular = lerpResult270.rgb;
				#endif

				surfaceDescription.Emission = lerpResult87.rgb;
				surfaceDescription.Smoothness = lerpResult228;
				surfaceDescription.Occlusion = lerpResult238;
				surfaceDescription.Alpha = ( 1.0 - step( ( BurnedMask314 * tex2DNode10.a ) , 0.5 ) );
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				BuiltinData builtinData;
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_WoodAlbedo = packedInput.ase_texcoord.xy * _WoodAlbedo_ST.xy + _WoodAlbedo_ST.zw;
				half4 tex2DNode10 = tex2D( _WoodAlbedo, uv_WoodAlbedo );
				float2 uv_DetailWoodAlbedo = packedInput.ase_texcoord.xy * _DetailWoodAlbedo_ST.xy + _DetailWoodAlbedo_ST.zw;
				half temp_output_9_0_g1 = tex2DNode10.r;
				half temp_output_18_0_g1 = ( 1.0 - temp_output_9_0_g1 );
				half3 appendResult16_g1 = (half3(temp_output_18_0_g1 , temp_output_18_0_g1 , temp_output_18_0_g1));
				float FirePower224 = StartBurning;
				half2 temp_output_45_0 = ( packedInput.ase_texcoord.xy * _UVTiling );
				half4 tex2DNode24 = tex2D( _CoalMasks, temp_output_45_0 );
				float CoalColor205 = tex2DNode24.r;
				half3 temp_cast_2 = (CoalColor205).xxx;
				float3 ase_worldPos = packedInput.ase_texcoord2.xyz;
				half3 ase_worldNormal = packedInput.ase_texcoord3.xyz;
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, ase_worldPos, ase_worldNormal, 1.0, _TriplanarScale, 1.0, 0 );
				half2 temp_cast_3 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				half2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * packedInput.ase_texcoord.xy ) , temp_cast_3 , 0.01);
				half4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				half clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				half clampResult155 = clamp( ( max( packedInput.ase_normal.y , 0.0 ) + ( max( packedInput.ase_texcoord1.xyz.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				half temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
				half clampResult192 = clamp( ( pow( CoalColor205 , _AshesPower ) * (0.0 + (temp_output_91_0 - 0.9) * (1.0 - 0.0) / (1.0 - 0.9)) * FirePower224 ) , 0.0 , 1.0 );
				half3 lerpResult306 = lerp( ( ( tex2DNode10.rgb * ( ( ( tex2D( _DetailWoodAlbedo, uv_DetailWoodAlbedo ).rgb * (unity_ColorSpaceDouble).rgb ) * temp_output_9_0_g1 ) + appendResult16_g1 ) ) * (0.77 + (FirePower224 - 0.0) * (0.0 - 0.77) / (1.0 - 0.0)) ) , temp_cast_2 , clampResult192);
				
				half2 texCoord262 = packedInput.ase_texcoord.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv_WoodNormal = packedInput.ase_texcoord.xy * _WoodNormal_ST.xy + _WoodNormal_ST.zw;
				float2 uv_CoalMasks = packedInput.ase_texcoord.xy * _CoalMasks_ST.xy + _CoalMasks_ST.zw;
				half clampResult43 = clamp( ( 1.0 - pow( tex2D( _CoalMasks, uv_CoalMasks ).b , (0.0 + (StartBurning - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) ) , 0.0 , 1.0 );
				half3 lerpResult93 = lerp( BlendNormal( UnpackNormalmapRGorAG( tex2D( _DetailWoodNormal, ( texCoord262 * 5.0 ) ), 1.0f ) , UnpackNormalmapRGorAG( tex2D( _WoodNormal, uv_WoodNormal ), 1.0f ) ) , UnpackNormalmapRGorAG( tex2D( _CoalNormal, temp_output_45_0 ), 1.0f ) , clampResult43);
				...
				half2 temp_cast_6 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord.xy * 2.0 ) ).g * 0.5 )).xx;
				half2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_6);
				half clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				half4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				half clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
				...
				float2 uv_WoodOcclusion_AOR = packedInput.ase_texcoord.xy * _WoodOcclusion_AOR_ST.xy + _WoodOcclusion_AOR_ST.zw;
				float CoalNoise2206 = tex2DNode24.b;
				half lerpResult238 = lerp( tex2D( _WoodOcclusion_AOR, uv_WoodOcclusion_AOR ).r , ( temp_output_123_0 * ( 1.0 - ( CoalNoise2206 + clampResult180 ) ) ) , FirePower224);
		...
		Pass
		{
					...
					)
			{
				...
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, ase_worldPos, ase_worldNormal, 1.0, _TriplanarScale, 1.0, 0 );
				float BurnedMask314 = ( (20.0 + (FirePower224 - 0.0) * (_MaskPower - 20.0) / (1.0 - 0.0)) * triplanar294.x );
				float2 uv_WoodAlbedo = packedInput.ase_texcoord2.xy * _WoodAlbedo_ST.xy + _WoodAlbedo_ST.zw;
				half4 tex2DNode10 = tex2D( _WoodAlbedo, uv_WoodAlbedo );
		...
		Pass
		{
					...
					)
			{
				...
				half2 texCoord262 = packedInput.ase_texcoord3.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv_WoodNormal = packedInput.ase_texcoord3.xy * _WoodNormal_ST.xy + _WoodNormal_ST.zw;
				half2 temp_output_45_0 = ( packedInput.ase_texcoord3.xy * _UVTiling );
				float2 uv_CoalMasks = packedInput.ase_texcoord3.xy * _CoalMasks_ST.xy + _CoalMasks_ST.zw;
				half clampResult43 = clamp( ( 1.0 - pow( tex2D( _CoalMasks, uv_CoalMasks ).b , (0.0 + (StartBurning - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) ) , 0.0 , 1.0 );
				half3 lerpResult93 = lerp( BlendNormal( UnpackNormalmapRGorAG( tex2D( _DetailWoodNormal, ( texCoord262 * 5.0 ) ), 1.0f ) , UnpackNormalmapRGorAG( tex2D( _WoodNormal, uv_WoodNormal ), 1.0f ) ) , UnpackNormalmapRGorAG( tex2D( _CoalNormal, temp_output_45_0 ), 1.0f ) , clampResult43);
				...
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, ase_worldPos, normalWS, 1.0, _TriplanarScale, 1.0, 0 );
				float BurnedMask314 = ( (20.0 + (FirePower224 - 0.0) * (_MaskPower - 20.0) / (1.0 - 0.0)) * triplanar294.x );
				float2 uv_WoodAlbedo = packedInput.ase_texcoord3.xy * _WoodAlbedo_ST.xy + _WoodAlbedo_ST.zw;
				half4 tex2DNode10 = tex2D( _WoodAlbedo, uv_WoodAlbedo );
		...
		Pass
		{
				...
				)
			{
				...
				half3 ase_worldNormal = packedInput.ase_texcoord5.xyz;
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, ase_worldPos, ase_worldNormal, 1.0, _TriplanarScale, 1.0, 0 );
				float BurnedMask314 = ( (20.0 + (FirePower224 - 0.0) * (_MaskPower - 20.0) / (1.0 - 0.0)) * triplanar294.x );
				float2 uv_WoodAlbedo = packedInput.ase_texcoord3.xy * _WoodAlbedo_ST.xy + _WoodAlbedo_ST.zw;
				half4 tex2DNode10 = tex2D( _WoodAlbedo, uv_WoodAlbedo );
		...
		Pass
		{
						...
						)
			{
				...
				GlobalSurfaceDescription surfaceDescription = (GlobalSurfaceDescription)0;
				float2 uv_WoodAlbedo = packedInput.ase_texcoord7.xy * _WoodAlbedo_ST.xy + _WoodAlbedo_ST.zw;
				half4 tex2DNode10 = tex2D( _WoodAlbedo, uv_WoodAlbedo );
				float2 uv_DetailWoodAlbedo = packedInput.ase_texcoord7.xy * _DetailWoodAlbedo_ST.xy + _DetailWoodAlbedo_ST.zw;
				half temp_output_9_0_g1 = tex2DNode10.r;
				half temp_output_18_0_g1 = ( 1.0 - temp_output_9_0_g1 );
				half3 appendResult16_g1 = (half3(temp_output_18_0_g1 , temp_output_18_0_g1 , temp_output_18_0_g1));
				float FirePower224 = StartBurning;
				half2 temp_output_45_0 = ( packedInput.ase_texcoord7.xy * _UVTiling );
				half4 tex2DNode24 = tex2D( _CoalMasks, temp_output_45_0 );
				float CoalColor205 = tex2DNode24.r;
				half3 temp_cast_2 = (CoalColor205).xxx;
				float3 ase_worldPos = GetAbsolutePositionWS( positionRWS );
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, ase_worldPos, normalWS, 1.0, _TriplanarScale, 1.0, 0 );
				half2 temp_cast_3 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord7.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				half2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * packedInput.ase_texcoord7.xy ) , temp_cast_3 , 0.01);
				half4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				half clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				half clampResult155 = clamp( ( max( packedInput.ase_normal.y , 0.0 ) + ( max( packedInput.ase_texcoord8.xyz.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				half temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
				half clampResult192 = clamp( ( pow( CoalColor205 , _AshesPower ) * (0.0 + (temp_output_91_0 - 0.9) * (1.0 - 0.0) / (1.0 - 0.9)) * FirePower224 ) , 0.0 , 1.0 );
				half3 lerpResult306 = lerp( ( ( tex2DNode10.rgb * ( ( ( tex2D( _DetailWoodAlbedo, uv_DetailWoodAlbedo ).rgb * (unity_ColorSpaceDouble).rgb ) * temp_output_9_0_g1 ) + appendResult16_g1 ) ) * (0.77 + (FirePower224 - 0.0) * (0.0 - 0.77) / (1.0 - 0.0)) ) , temp_cast_2 , clampResult192);
				
				half2 texCoord262 = packedInput.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				float2 uv_WoodNormal = packedInput.ase_texcoord7.xy * _WoodNormal_ST.xy + _WoodNormal_ST.zw;
				float2 uv_CoalMasks = packedInput.ase_texcoord7.xy * _CoalMasks_ST.xy + _CoalMasks_ST.zw;
				half clampResult43 = clamp( ( 1.0 - pow( tex2D( _CoalMasks, uv_CoalMasks ).b , (0.0 + (StartBurning - 0.0) * (2.0 - 0.0) / (1.0 - 0.0)) ) ) , 0.0 , 1.0 );
				half3 lerpResult93 = lerp( BlendNormal( UnpackNormalmapRGorAG( tex2D( _DetailWoodNormal, ( texCoord262 * 5.0 ) ), 1.0f ) , UnpackNormalmapRGorAG( tex2D( _WoodNormal, uv_WoodNormal ), 1.0f ) ) , UnpackNormalmapRGorAG( tex2D( _CoalNormal, temp_output_45_0 ), 1.0f ) , clampResult43);
				...
				half2 temp_cast_6 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord7.xy * 2.0 ) ).g * 0.5 )).xx;
				half2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_6);
				half clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				half4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				half clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
				...
				float2 uv_WoodOcclusion_AOR = packedInput.ase_texcoord7.xy * _WoodOcclusion_AOR_ST.xy + _WoodOcclusion_AOR_ST.zw;
				float CoalNoise2206 = tex2DNode24.b;
				half lerpResult238 = lerp( tex2D( _WoodOcclusion_AOR, uv_WoodOcclusion_AOR ).r , ( temp_output_123_0 * ( 1.0 - ( CoalNoise2206 + clampResult180 ) ) ) , FirePower224);
...
/*ASEBEGIN
Version=18500
249;32;1502;646;2257.183;-103.3461;1;True;False
...
Node;AmplifyShaderEditor.TexturePropertyNode;305;-4531.613,842.5508;Float;True;Property;_TriplanarMap;TriplanarMap;18;0;Create;True;0;0;False;0;False;None;86104a73ce569514d93898e3cd85d452;False;white;Auto;Texture2D;-1;0;2;SAMPLER2D;0;SAMPLERSTATE;1
Node;AmplifyShaderEditor.RangedFloatNode;296;-4494.289,1054.009;Float;False;Property;_TriplanarScale;TriplanarScale;21;0;Create;True;0;0;False;0;False;0.2;1.6;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;236;-2970.067,-460.4288;Float;False;Property;_UVTiling;UVTiling;14;0;Create;True;0;0;False;0;False;1,1;1,1;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.SamplerNode;174;-3824.649,1497.726;Inherit;True;Property;_TextureSample5;Texture Sample 5;5;0;Create;True;0;0;False;0;False;-1;None;2d479324bd85dcd4facb271ae1f53661;True;0;False;white;Auto;False;Instance;33;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;176;-3708.415,1719.024;Float;False;Constant;_CinderNoiseUVScale;CinderNoiseUVScale;10;0;Create;True;0;0;False;0;False;0.01;0.1;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;24;-2369.598,-739.6808;Inherit;True;Property;_TextureSample1;Texture Sample 1;5;0;Create;True;0;0;False;0;False;-1;2d479324bd85dcd4facb271ae1f53661;2d479324bd85dcd4facb271ae1f53661;True;0;False;white;Auto;False;Instance;33;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;29;-3149.637,1446.938;Inherit;True;Property;_TextureSample2;Texture Sample 2;5;0;Create;True;0;0;False;0;False;-1;2d479324bd85dcd4facb271ae1f53661;2d479324bd85dcd4facb271ae1f53661;True;0;False;white;Auto;False;Instance;33;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;178;-3005.34,1289.125;Float;False;Property;_CinderLow;CinderLow;12;0;Create;True;0;0;False;0;False;0.18;0.47;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;18;-2899.988,371.2204;Float;False;Constant;_CoalNoiseScale;CoalNoiseScale;9;0;Create;True;0;0;False;0;False;0.5;0.58;0;0;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;157;-2777.392,969.3057;Float;False;Property;_CinderSidePower;CinderSidePower;11;0;Create;True;0;0;False;0;False;1.55;1.66;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.SamplerNode;22;-2965.419,161.6456;Inherit;True;Property;_TextureSample0;Texture Sample 0;5;0;Create;True;0;0;False;0;False;-1;2d479324bd85dcd4facb271ae1f53661;2d479324bd85dcd4facb271ae1f53661;True;0;False;white;Auto;False;Instance;33;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;218;-2498.403,-106.1524;Float;False;Global;StartBurning;StartBurning;19;0;Create;True;0;0;False;0;False;0;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.Vector2Node;19;-2571.373,327.421;Float;False;Constant;_CoalNoiseUVPanner;CoalNoiseUVPanner;10;0;Create;True;0;0;False;0;False;0.15,0;0.15,0;0;3;FLOAT2;0;FLOAT;1;FLOAT;2
...
Node;AmplifyShaderEditor.RangedFloatNode;28;-3239.084,1718.399;Float;False;Global;StopBurning;StopBurning;11;0;Create;True;0;0;False;0;False;0.5;0;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;309;-4240.425,825.0985;Float;False;Property;_MaskPower;MaskPower;20;0;Create;True;0;0;False;0;False;3.5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;96;-1974.856,928.1199;Float;False;Property;_CinderPower;CinderPower;10;0;Create;True;0;0;False;0;False;2;0.65;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;9;-1962.441,184.8739;Inherit;True;Property;_rew;rew;5;0;Create;True;0;0;False;0;False;-1;2d479324bd85dcd4facb271ae1f53661;2d479324bd85dcd4facb271ae1f53661;True;0;False;white;Auto;False;Instance;33;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.TFHCRemapNode;311;-4008.742,736.876;Inherit;False;5;0;FLOAT;0;False;1;FLOAT;0;False;2;FLOAT;1;False;3;FLOAT;20;False;4;FLOAT;1.15;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;33;-1909.745,-306.4492;Inherit;True;Property;_CoalMasks;CoalMasks;5;0;Create;True;0;0;False;0;False;-1;2d479324bd85dcd4facb271ae1f53661;2d479324bd85dcd4facb271ae1f53661;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;261;-1554.599,-824.3876;Float;False;Constant;_DetailNormalUVScale;DetailNormalUVScale;22;0;Create;True;0;0;False;0;False;5;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ColorNode;48;-1456.608,57.06815;Float;False;Property;_CoalColor;CoalColor;9;1;[HDR];Create;True;0;0;False;0;False;0,0,0,0;6.883182,2.270369,1.189241,0;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;331;-1394.183,411.3461;Inherit;False;Constant;_Float2;Float 0;20;0;Create;True;0;0;False;0;False;3000;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;196;-1075.165,408.9827;Float;False;Property;_AshesPower;AshesPower;13;0;Create;True;0;0;False;0;False;3.6;1.23;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;11;-1170.334,-735.5777;Inherit;True;Property;_WoodNormal;WoodNormal;7;0;Create;True;0;0;False;0;False;-1;None;596b33ebc0887e74f8a8eb312c28ca7e;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;10;-67.9334,-631.02;Inherit;True;Property;_WoodAlbedo;WoodAlbedo;6;0;Create;True;0;0;False;0;False;-1;None;d63235a1baa078547836de0f1163621a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;255;-67.6104,-440.0819;Inherit;True;Property;_DetailWoodAlbedo;DetailWoodAlbedo;15;0;Create;True;0;0;False;0;False;-1;a0fff3e053e70494ba9c91d152aeffa0;69c23a9535a4c2143bdfda7b563b993a;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;13;-1168.178,-510.9188;Inherit;True;Property;_CoalNormal;CoalNormal;8;0;Create;True;0;0;False;0;False;-1;None;f91c76d43b07b034ba951400ad8c3133;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;257;210.7187,189.9626;Float;False;Property;_Specular;Specular;16;0;Create;True;0;0;False;0;False;0,0,0,0;0.2735849,0.2232556,0.2232556,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;239;-204.4312,622.5336;Inherit;True;Property;_WoodOcclusion_AOR;WoodOcclusion_AO(R);22;0;Create;True;0;0;False;0;False;-1;None;cda04cf139859604badb70af62700f4b;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.StepOpNode;316;976.8217,-552.5576;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-62.15375,381.0183;Float;False;Property;_WoodSm;WoodSm;17;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;330;841.5179,145.5841;Inherit;False;1;0;COLOR;0,0,0,0;False;1;COLOR;0
...
Node;AmplifyShaderEditor.OneMinusNode;317;1141.08,-554.2645;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.WireNode;329;395.7673,-3.570866;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;322;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;DepthOnly;0;4;DepthOnly;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-6;255;False;-1;255;True;-7;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;320;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;318;1413.548,74.58441;Half;False;True;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;2;BurnedHDRP/Coal_Mask_LocalCoord;53b46d85872c5b24c8f4f0a1c3fe4c87;True;GBuffer;0;0;GBuffer;35;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=TransparentCutout=RenderType;Queue=AlphaTest=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-13;255;False;-1;255;True;-12;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;False;True;0;True;-14;False;True;1;LightMode=GBuffer;False;0;;0;0;Standard;41;Surface Type;0;  Rendering Pass;1;  Refraction Model;0;    Blending Mode;0;    Blend Preserves Specular;1;  Receive Fog;1;  Back Then Front Rendering;0;  Transparent Depth Prepass;0;  Transparent Depth Postpass;0;  Transparent Writes Motion Vector;0;  Distortion;0;    Distortion Mode;0;    Distortion Depth Test;1;  ZWrite;0;  Z Test;4;Double-Sided;0;Alpha Clipping;1;  Use Shadow Threshold;0;Material Type,InvertActionOnDeselection;4;  Energy Conserving Specular;1;  Transmission;1;Receive Decals;1;Receives SSR;1;Motion Vectors;1;  Add Precomputed Velocity;0;Specular AA;0;Specular Occlusion Mode;1;Override Baked GI;0;Depth Offset;0;DOTS Instancing;0;LOD CrossFade;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position;1;0;11;True;True;True;True;True;True;False;False;False;False;True;False;;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;324;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Distortion;0;6;Distortion;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;4;1;False;-1;1;False;-1;4;1;False;-1;1;False;-1;True;1;False;-1;1;False;-1;False;False;False;False;False;False;False;False;False;False;False;False;True;True;0;True;-10;255;False;-1;255;True;-11;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;2;False;-1;True;3;False;-1;False;True;1;LightMode=DistortionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;328;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Forward;0;10;Forward;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;True;0;True;-28;False;True;True;True;True;True;0;True;-44;False;False;True;True;0;True;-4;255;False;-1;255;True;-5;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;0;True;-23;True;0;True;-30;False;True;1;LightMode=Forward;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;327;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPostpass;0;9;TransparentDepthPostpass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPostpass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;326;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentDepthPrepass;0;8;TransparentDepthPrepass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;True;-25;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=TransparentDepthPrepass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;325;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;TransparentBackface;0;7;TransparentBackface;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;True;1;0;True;-19;0;True;-20;1;0;True;-21;0;True;-22;False;False;False;False;False;False;False;False;True;1;False;-1;False;True;True;True;True;True;0;True;-44;False;False;False;True;0;True;-23;True;0;True;-31;False;True;1;LightMode=TransparentBackface;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;321;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;SceneSelectionPass;0;3;SceneSelectionPass;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;False;True;False;False;False;False;0;False;-1;False;False;False;False;False;False;False;True;1;LightMode=SceneSelectionPass;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;323;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;Motion Vectors;0;5;Motion Vectors;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;0;True;-25;False;False;False;False;True;True;0;True;-8;255;False;-1;255;True;-9;7;False;-1;3;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;False;False;True;1;LightMode=MotionVectors;False;0;;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;319;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.Rendering.HighDefinition.HDLitGUI;0;1;New Amplify Shader;53b46d85872c5b24c8f4f0a1c3fe4c87;True;META;0;1;META;0;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;False;True;3;RenderPipeline=HDRenderPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;5;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;;0;0;Standard;0;False;0
...
WireConnection;329;0;93;0
WireConnection;318;0;306;0
WireConnection;318;1;329;0
WireConnection;318;5;270;0
WireConnection;318;6;330;0
WireConnection;318;7;228;0
WireConnection;318;8;238;0
WireConnection;318;9;317;0
ASEEND*/
//CHKSM=40F0211FED85EC7DC729BA76CE1F0DCF880CB7F4