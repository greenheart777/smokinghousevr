...
Shader "BurnedHDRP/Coal_NoTriplanar_Met_LocalCoord"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				half2 temp_cast_4 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord5.xy * 2.0 ) ).g * 0.5 )).xx;
				half2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_4);
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half2 temp_cast_4 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord.xy * 2.0 ) ).g * 0.5 )).xx;
				half2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_4);
				half clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				half4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				half clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
		...
		Pass
		{
						...
						)
			{
				...
				half2 temp_cast_4 = (( tex2D( _CoalMasks, ( packedInput.ase_texcoord7.xy * 2.0 ) ).g * 0.5 )).xx;
				half2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_4);
				half clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
				half4 lerpResult12 = lerp( float4( 0,0,0,0 ) , ( CoalColor205 * _CoalColor * clampResult217 * 3000.0 ) , clampResult43);
				half clampResult49 = clamp( temp_output_91_0 , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18500
825;216;1519;603;2267.978;-77.6236;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;310;-1382.081,372.4109;Inherit;False;Constant;_Float1;Float 0;20;0;Create;True;0;0;False;0;False;3000;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;322;267.4452,30.3535;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=A9BB2E88B723DD808786CBFC6D85035D694BD50F