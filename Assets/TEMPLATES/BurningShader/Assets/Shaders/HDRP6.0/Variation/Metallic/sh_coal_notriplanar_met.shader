...
Shader "BurnedHDRP/Coal_NoTriplanar_Met"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
						...
						)
			{
				...
				half4 transform117 = mul(GetObjectToWorldMatrix(),half4( packedInput.ase_normal , 0.0 ));
				transform117.xyz = GetAbsolutePositionWS((transform117).xyz);
				half4 transform152 = mul(GetObjectToWorldMatrix(),half4( packedInput.ase_texcoord6.xyz , 0.0 ));
				transform152.xyz = GetAbsolutePositionWS((transform152).xyz);
				half2 temp_cast_5 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord5.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				half2 lerpResult175 = lerp( packedInput.ase_texcoord5.xy , temp_cast_5 , 0.01);
				half4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				half clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				half clampResult155 = clamp( ( max( transform117.y , 0.0 ) + ( max( transform152.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				...
				half3 lerpResult306 = lerp( ( ( tex2DNode10.rgb * ( ( ( tex2D( _DetailWoodAlbedo, uv_DetailWoodAlbedo ).rgb * (unity_ColorSpaceDouble).rgb ) * temp_output_9_0_g1 ) + appendResult16_g1 ) ) * (1.2 + (FirePower224 - 0.0) * (0.0 - 1.2) / (1.0 - 0.0)) ) , temp_cast_2 , clampResult192);
		...
		Pass
		{
			...
			float4 Frag(PackedVaryingsMeshToPS packedInput  ) : SV_Target
			{
				...
				half4 transform117 = mul(GetObjectToWorldMatrix(),half4( packedInput.ase_normal , 0.0 ));
				transform117.xyz = GetAbsolutePositionWS((transform117).xyz);
				half4 transform152 = mul(GetObjectToWorldMatrix(),half4( packedInput.ase_texcoord1.xyz , 0.0 ));
				transform152.xyz = GetAbsolutePositionWS((transform152).xyz);
				half2 temp_cast_5 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				half2 lerpResult175 = lerp( packedInput.ase_texcoord.xy , temp_cast_5 , 0.01);
				half4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				half clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				half clampResult155 = clamp( ( max( transform117.y , 0.0 ) + ( max( transform152.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				half temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
		...
		Pass
		{
						...
						)
			{
				...
				half4 transform117 = mul(GetObjectToWorldMatrix(),half4( packedInput.ase_normal , 0.0 ));
				transform117.xyz = GetAbsolutePositionWS((transform117).xyz);
				half4 transform152 = mul(GetObjectToWorldMatrix(),half4( packedInput.ase_texcoord8.xyz , 0.0 ));
				transform152.xyz = GetAbsolutePositionWS((transform152).xyz);
				half2 temp_cast_5 = (tex2D( _CoalMasks, ( ( packedInput.ase_texcoord7.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				half2 lerpResult175 = lerp( packedInput.ase_texcoord7.xy , temp_cast_5 , 0.01);
				half4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				half clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				half clampResult155 = clamp( ( max( transform117.y , 0.0 ) + ( max( transform152.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				half temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
...
/*ASEBEGIN
Version=18500
825;216;1519;603;2290.825;-46.40019;1;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;218;-2498.403,-106.1524;Float;False;Global;StartBurning;StartBurning;20;0;Create;True;0;0;False;0;False;0;0.9972369;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;11;-1170.334,-735.5777;Inherit;True;Property;_WoodNormal;WoodNormal;6;0;Create;True;0;0;False;0;False;-1;None;None;True;0;True;bump;Auto;True;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;FLOAT3;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.SamplerNode;10;-176.3099,-605.78;Inherit;True;Property;_WoodAlbedo;WoodAlbedo;5;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.RangedFloatNode;310;-1364.328,384.9512;Inherit;False;Constant;_Float1;Float 0;20;0;Create;True;0;0;False;0;False;3000;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;267;-62.15375,384.0183;Float;False;Property;_WoodSm;WoodSm;15;0;Create;True;0;0;False;0;False;0;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.SamplerNode;239;163.4688,200.0336;Inherit;True;Property;_WoodAoMet_AOR_MetG;WoodAoMet_AO(R)_Met(G);17;0;Create;True;0;0;False;0;False;-1;None;None;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.WireNode;322;227.7213,-0.526947;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
WireConnection;311;4;239;2
WireConnection;311;6;87;0
WireConnection;311;7;228;0
WireConnection;311;8;238;0
ASEEND*/
//CHKSM=E8CDFCBB850E033516A6BE9E015B9CC12918BFFF