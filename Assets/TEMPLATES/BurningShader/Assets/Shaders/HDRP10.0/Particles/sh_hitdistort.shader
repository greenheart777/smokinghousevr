	...
	SubShader
	{
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput ) : SV_Target
			{
				...
				float3 tex2DNode3 = UnpackNormalScale( tex2D( _TextureSample0, ( packedInput.ase_texcoord2.xy * _Tile ) ), 1.0f );
				float2 appendResult17 = (float2(tex2DNode3.r , tex2DNode3.g));
				float3 appendResult18 = (float3(( appendResult17 * _Distort ) , tex2DNode3.b));
				float4 fetchOpaqueVal2 = ASEHDSampleSceneColor(( ase_screenPosNorm + float4( ( appendResult18 * packedInput.ase_color.a ) , 0.0 ) ).xy, 0.0, GetInverseCurrentExposureMultiplier());
		...
		Pass
		{
			...
			float4 Frag( VertexOutput packedInput  ) : SV_Target
			{
				...
				float4 ase_screenPosNorm = screenPos / screenPos.w;
				ase_screenPosNorm.z = ( UNITY_NEAR_CLIP_VALUE >= 0 ) ? ase_screenPosNorm.z : ase_screenPosNorm.z * 0.5 + 0.5;
				float3 tex2DNode3 = UnpackNormalScale( tex2D( _TextureSample0, ( packedInput.ase_texcoord1.xy * _Tile ) ), 1.0f );
				float2 appendResult17 = (float2(tex2DNode3.r , tex2DNode3.g));
				float3 appendResult18 = (float3(( appendResult17 * _Distort ) , tex2DNode3.b));
				float4 fetchOpaqueVal2 = ASEHDSampleSceneColor(( ase_screenPosNorm + float4( ( appendResult18 * packedInput.ase_color.a ) , 0.0 ) ).xy, 0.0, GetInverseCurrentExposureMultiplier());
...
/*ASEBEGIN
Version=18912
-1920;0;1920;1019;859.1919;200.87;1;True;True
Node;AmplifyShaderEditor.VertexColorNode;35;-571.8626,644.7407;Inherit;False;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.SamplerNode;24;-690.4647,433.7272;Inherit;True;Property;_BigDot;BigDot;2;0;Create;True;0;0;0;False;0;False;-1;4dc913430fb6d6c4d82675d47f4820f0;4dc913430fb6d6c4d82675d47f4820f0;True;0;False;white;Auto;False;Object;-1;Auto;Texture2D;8;0;SAMPLER2D;;False;1;FLOAT2;0,0;False;2;FLOAT;0;False;3;FLOAT2;0,0;False;4;FLOAT2;0,0;False;5;FLOAT;1;False;6;FLOAT;0;False;7;SAMPLERSTATE;;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
Node;AmplifyShaderEditor.ColorNode;52;259.6573,-44.37982;Inherit;False;Constant;_Color0;Color 0;4;0;Create;True;0;0;0;False;0;False;0,0,0,0;0,0,0,0;True;0;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
Node;AmplifyShaderEditor.RangedFloatNode;7;-1477.855,473.2809;Float;False;Property;_Distort;Distort;1;0;Create;True;0;0;0;False;0;False;0.7226186;0.107;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.ScreenColorNode;2;262.6982,147.386;Float;False;Global;_GrabScreen0;Grab Screen 0;0;0;Create;True;0;0;0;False;0;False;Object;-1;False;False;False;2;0;FLOAT2;0,0;False;1;FLOAT;0;False;5;COLOR;0;FLOAT;1;FLOAT;2;FLOAT;3;FLOAT;4
...
ASEEND*/
//CHKSM=8EAB88BD2C7C31AE96AF0DD295EA6FD6F8F10B5B