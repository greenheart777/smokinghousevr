...
Shader "BurnedURP/NotGlobal/Coal_Mask"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 uv_DetailWoodAlbedo = IN.ase_texcoord7.xy * _DetailWoodAlbedo_ST.xy + _DetailWoodAlbedo_ST.zw;
				...
				half4 transform117 = mul(GetObjectToWorldMatrix(),half4( IN.ase_normal , 0.0 ));
				half4 transform152 = mul(GetObjectToWorldMatrix(),half4( IN.ase_texcoord8.xyz , 0.0 ));
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, WorldPosition, WorldNormal, 1.0, _TriplanarScale, 1.0, 0 );
				half2 temp_cast_5 = (tex2D( _CoalMasks, ( ( IN.ase_texcoord7.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				half2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * IN.ase_texcoord7.xy ) , temp_cast_5 , 0.01);
				...
				half2 texCoord262 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				...
				half2 temp_cast_6 = (( tex2D( _CoalMasks, ( IN.ase_texcoord7.xy * 2.0 ) ).g * 0.5 )).xx;
				...
				half4 temp_cast_8 = (0.0).xxxx;
				half4 lerpResult270 = lerp( _Specular , temp_cast_8 , FirePower224);
				...
				float Alpha = ( 1.0 - step( ( BurnedMask314 * tex2DNode10.a ) , 0.5 ) );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float BurnedMask314 = ( (20.0 + (FirePower224 - 0.0) * (_MaskPower - 20.0) / (1.0 - 0.0)) * triplanar294.x );
				float2 uv_WoodAlbedo = IN.ase_texcoord3.xy * _WoodAlbedo_ST.xy + _WoodAlbedo_ST.zw;
				half4 tex2DNode10 = tex2D( _WoodAlbedo, uv_WoodAlbedo );
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				half4 tex2DNode10 = tex2D( _WoodAlbedo, uv_WoodAlbedo );
				float2 uv_DetailWoodAlbedo = IN.ase_texcoord2.xy * _DetailWoodAlbedo_ST.xy + _DetailWoodAlbedo_ST.zw;
				half temp_output_9_0_g1 = tex2DNode10.r;
				half temp_output_18_0_g1 = ( 1.0 - temp_output_9_0_g1 );
				half3 appendResult16_g1 = (half3(temp_output_18_0_g1 , temp_output_18_0_g1 , temp_output_18_0_g1));
				float FirePower224 = _StartBurning;
				...
				half3 temp_cast_2 = (CoalColor205).xxx;
				half4 transform117 = mul(GetObjectToWorldMatrix(),half4( IN.ase_normal , 0.0 ));
				half4 transform152 = mul(GetObjectToWorldMatrix(),half4( IN.ase_texcoord3.xyz , 0.0 ));
				half3 ase_worldNormal = IN.ase_texcoord4.xyz;
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, WorldPosition, ase_worldNormal, 1.0, _TriplanarScale, 1.0, 0 );
				half2 temp_cast_5 = (tex2D( _CoalMasks, ( ( IN.ase_texcoord2.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				half2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * IN.ase_texcoord2.xy ) , temp_cast_5 , 0.01);
				half4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				half clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				half clampResult155 = clamp( ( max( transform117.y , 0.0 ) + ( max( transform152.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				half temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (_StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
				...
				half2 temp_cast_6 = (( tex2D( _CoalMasks, ( IN.ase_texcoord2.xy * 2.0 ) ).g * 0.5 )).xx;
				half2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_6);
				half clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18500
-1914;6;1907;1013;4503.396;43.67682;2.347908;True;True
...
Node;AmplifyShaderEditor.RangedFloatNode;296;-4486.289,1076.009;Float;False;Property;_TriplanarScale;TriplanarScale;22;0;Create;True;0;0;False;0;False;0.2;0.28;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;178;-3005.34,1289.125;Float;False;Property;_CinderLow;CinderLow;12;0;Create;True;0;0;False;0;False;0.18;0.25;0;3;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;309;-4241.848,827.9438;Float;False;Property;_MaskPower;MaskPower;20;0;Create;True;0;0;False;0;False;1.15;3.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.GetLocalVarNode;315;411.7259,-625.407;Inherit;False;314;BurnedMask;1;0;OBJECT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.SimpleMultiplyOpNode;310;673.2767,-559.6989;Inherit;False;2;2;0;FLOAT;0;False;1;FLOAT;0;False;1;FLOAT;0
Node;AmplifyShaderEditor.StepOpNode;332;841.2981,-558.5112;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;333;993.5406,-558.6145;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;322;330.5646,-2.613434;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;323;-1349.308,396.614;Inherit;False;Constant;_Float0;Float 0;18;0;Create;True;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;320;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Meta;0;4;Meta;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;False;True;2;False;-1;False;False;False;False;False;False;False;False;True;1;LightMode=Meta;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;316;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ExtraPrePass;0;0;ExtraPrePass;5;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;1;1;False;-1;0;False;-1;0;1;False;-1;0;False;-1;False;False;False;False;False;False;False;False;True;0;False;-1;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;0;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;319;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;DepthOnly;0;3;DepthOnly;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;True;False;False;False;False;0;False;-1;False;False;False;False;True;1;False;-1;False;False;True;1;LightMode=DepthOnly;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;318;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;ShadowCaster;0;2;ShadowCaster;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;False;False;False;False;False;False;False;False;True;0;False;-1;False;False;False;False;False;False;True;1;False;-1;True;3;False;-1;False;True;1;LightMode=ShadowCaster;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;321;1413.548,74.58441;Float;False;False;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;New Amplify Shader;94348b07e5e8bab40bd6c8a1e3df54cd;True;Universal2D;0;5;Universal2D;0;False;False;False;False;False;False;False;False;True;0;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=Opaque=RenderType;Queue=Geometry=Queue=0;True;0;0;True;2;5;False;-1;10;False;-1;2;5;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;False;True;1;False;-1;True;0;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=Universal2D;False;0;Hidden/InternalErrorShader;0;0;Standard;0;False;0
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;317;1413.548,74.58441;Half;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;BurnedURP/NotGlobal/Coal_Mask;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;1;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=TransparentCutout=RenderType;Queue=AlphaTest=Queue=0;True;2;0;True;2;5;False;-1;10;False;-1;2;5;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;0;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;0;Surface;1;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
...
WireConnection;317;1;322;0
WireConnection;317;2;87;0
WireConnection;317;9;270;0
WireConnection;317;4;228;0
WireConnection;317;5;238;0
WireConnection;317;6;333;0
ASEEND*/
//CHKSM=9EBC3355BD2E7B6FA007378E167F8CD7A45510E2