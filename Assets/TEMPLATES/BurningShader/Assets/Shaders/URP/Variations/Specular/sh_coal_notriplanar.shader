...
Shader "BurnedURP/Coal_NoTriplanar"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 lerpResult175 = lerp( IN.ase_texcoord7.xy , temp_cast_5 , 0.01);
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float2 lerpResult175 = lerp( IN.ase_texcoord2.xy , temp_cast_5 , 0.01);
				float4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				float clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				float clampResult155 = clamp( ( max( transform117.y , 0.0 ) + ( max( transform152.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				float temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
...
/*ASEBEGIN
Version=18500
252;108;1189;607;1903.099;-10.47163;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;317;-1341.513,381.3889;Inherit;False;Constant;_Float1;Float 0;18;0;Create;True;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.WireNode;316;242.1348,16.38659;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
ASEEND*/
//CHKSM=C0C74497362F33C570E66B45890D3F7D7303B712