	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float4 transform117 = mul(GetObjectToWorldMatrix(),float4( IN.ase_normal , 0.0 ));
				float4 transform152 = mul(GetObjectToWorldMatrix(),float4( IN.ase_texcoord8.xyz , 0.0 ));
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, WorldPosition, WorldNormal, 1.0, _TriplanarScale, 1.0, 0 );
				float2 temp_cast_5 = (tex2D( _CoalMasks, ( ( IN.ase_texcoord7.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				float2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * IN.ase_texcoord7.xy ) , temp_cast_5 , 0.01);
				...
				float2 texCoord262 = IN.ase_texcoord7.xy * float2( 1,1 ) + float2( 0,0 );
				...
				float2 temp_cast_6 = (( tex2D( _CoalMasks, ( IN.ase_texcoord7.xy * 2.0 ) ).g * 0.5 )).xx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float3 temp_cast_2 = (CoalColor205).xxx;
				float4 transform117 = mul(GetObjectToWorldMatrix(),float4( IN.ase_normal , 0.0 ));
				float4 transform152 = mul(GetObjectToWorldMatrix(),float4( IN.ase_texcoord3.xyz , 0.0 ));
				float3 ase_worldNormal = IN.ase_texcoord4.xyz;
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, WorldPosition, ase_worldNormal, 1.0, _TriplanarScale, 1.0, 0 );
				float2 temp_cast_5 = (tex2D( _CoalMasks, ( ( IN.ase_texcoord2.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				float2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * IN.ase_texcoord2.xy ) , temp_cast_5 , 0.01);
				float4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				float clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				float clampResult155 = clamp( ( max( transform117.y , 0.0 ) + ( max( transform152.y , 0.0 ) * _CinderSidePower ) + clampResult180 ) , 0.0 , 1.0 );
				float temp_output_91_0 = ( clampResult155 * _CinderPower * 100.0 * pow( tex2DNode29.g , (6.0 + (StopBurning - 0.0) * (-10.0 - 6.0) / (1.0 - 0.0)) ) );
				...
				float2 temp_cast_6 = (( tex2D( _CoalMasks, ( IN.ase_texcoord2.xy * 2.0 ) ).g * 0.5 )).xx;
				float2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_6);
				float clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18500
252;108;1189;607;2261.634;-122.5541;1;True;False
...
Node;AmplifyShaderEditor.RangedFloatNode;296;-4486.289,1076.009;Float;False;Property;_TriplanarScale;TriplanarScale;20;0;Create;True;0;0;False;0;False;0.2;0.28;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;178;-3005.34,1289.125;Float;False;Property;_CinderLow;CinderLow;11;0;Create;True;0;0;False;0;False;0.18;0.25;0;3;0;1;FLOAT;0
Node;AmplifyShaderEditor.RangedFloatNode;218;-2498.403,-106.1524;Float;False;Global;StartBurning;StartBurning;20;0;Create;True;0;0;False;0;False;0;0.6734224;0;1;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.RangedFloatNode;309;-4241.848,827.9438;Float;False;Property;_MaskPower;MaskPower;19;0;Create;True;0;0;False;0;False;1.15;3.5;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;317;1413.548,74.58441;Half;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;BurnedURP/Coal_Mask;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;1;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=TransparentCutout=RenderType;Queue=AlphaTest=Queue=0;True;2;0;True;2;5;False;-1;10;False;-1;2;5;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;0;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;0;Surface;1;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
...
ASEEND*/
//CHKSM=606CFF871A90655FE7CCA7D690C492EAE44D8E51