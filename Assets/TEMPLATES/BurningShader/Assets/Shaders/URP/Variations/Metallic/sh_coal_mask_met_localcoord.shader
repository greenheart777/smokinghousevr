...
Shader "BurnedURP/Coal_Mask_Met_LocalCoord"
{
	Properties
	{
	...
	SubShader
	{
		...
		Pass
		{
			...
			half4 frag ( VertexOutput IN  ) : SV_Target
			{
				...
				float2 temp_cast_3 = (tex2D( _CoalMasks, ( ( IN.ase_texcoord7.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				float2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * IN.ase_texcoord7.xy ) , temp_cast_3 , 0.01);
				...
				float2 temp_cast_4 = (( tex2D( _CoalMasks, ( IN.ase_texcoord7.xy * 2.0 ) ).g * 0.5 )).xx;
		...
		Pass
		{
			...
			half4 frag(VertexOutput IN  ) : SV_TARGET
			{
				...
				float4 triplanar294 = TriplanarSampling294( _TriplanarMap, WorldPosition, ase_worldNormal, 1.0, _TriplanarScale, 1.0, 0 );
				float2 temp_cast_3 = (tex2D( _CoalMasks, ( ( IN.ase_texcoord2.xy * float2( 0.5,0.5 ) ) + ( float2( 0.005,0.01 ) * _TimeParameters.x ) ) ).b).xx;
				float2 lerpResult175 = lerp( ( ( triplanar294.x * 0.5 ) * IN.ase_texcoord2.xy ) , temp_cast_3 , 0.01);
				float4 tex2DNode29 = tex2D( _CoalMasks, lerpResult175 );
				float clampResult180 = clamp( ( CoalColor205 * _CinderLow * tex2DNode29.g ) , 0.0 , 1.0 );
				...
				float2 temp_cast_4 = (( tex2D( _CoalMasks, ( IN.ase_texcoord2.xy * 2.0 ) ).g * 0.5 )).xx;
				float2 panner21 = ( 1.0 * _Time.y * float2( 0.15,0 ) + temp_cast_4);
				float clampResult217 = clamp( ( tex2D( _CoalMasks, panner21 ).g * 33.0 * CoalColor205 ) , 0.0 , 1.0 );
...
/*ASEBEGIN
Version=18500
617;72;1199;607;4628.289;-521.1143;1;True;False
...
Node;AmplifyShaderEditor.StepOpNode;325;999.8328,-549.0956;Inherit;False;2;0;FLOAT;0;False;1;FLOAT;0.5;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.OneMinusNode;324;1158.833,-548.0956;Inherit;False;1;0;FLOAT;0;False;1;FLOAT;0
...
Node;AmplifyShaderEditor.LerpOp;93;-320.8291,-283.1608;Inherit;False;3;0;FLOAT3;0,0,0;False;1;FLOAT3;0,0,0;False;2;FLOAT;0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.WireNode;322;319.9053,-0.4226952;Inherit;False;1;0;FLOAT3;0,0,0;False;1;FLOAT3;0
...
Node;AmplifyShaderEditor.RangedFloatNode;323;-1360.089,395.7709;Inherit;False;Constant;_Float1;Float 0;18;0;Create;True;0;0;False;0;False;4;0;0;0;0;1;FLOAT;0
...
Node;AmplifyShaderEditor.TemplateMultiPassMasterNode;317;1413.548,74.58441;Float;False;True;-1;2;UnityEditor.ShaderGraph.PBRMasterGUI;0;2;BurnedURP/Coal_Mask_Met_LocalCoord;94348b07e5e8bab40bd6c8a1e3df54cd;True;Forward;0;1;Forward;17;False;False;False;False;False;False;False;False;True;1;False;-1;True;0;False;-1;False;False;False;False;False;False;False;False;True;3;RenderPipeline=UniversalPipeline;RenderType=TransparentCutout=RenderType;Queue=AlphaTest=Queue=0;True;2;0;True;2;5;False;-1;10;False;-1;2;5;False;-1;10;False;-1;False;False;False;False;False;False;False;False;False;True;True;True;True;True;0;False;-1;False;False;False;True;False;255;False;-1;255;False;-1;255;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;7;False;-1;1;False;-1;1;False;-1;1;False;-1;True;1;False;-1;True;3;False;-1;True;True;0;False;-1;0;False;-1;True;1;LightMode=UniversalForward;False;0;Hidden/InternalErrorShader;0;0;Standard;36;Workflow;1;Surface;0;  Refraction Model;0;  Blend;0;Two Sided;1;Fragment Normal Space,InvertActionOnDeselection;0;Transmission;0;  Transmission Shadow;0.5,False,-1;Translucency;0;  Translucency Strength;1,False,-1;  Normal Distortion;0.5,False,-1;  Scattering;2,False,-1;  Direct;0.9,False,-1;  Ambient;0.1,False,-1;  Shadow;0.5,False,-1;Cast Shadows;1;  Use Shadow Threshold;0;Receive Shadows;1;GPU Instancing;1;LOD CrossFade;1;Built-in Fog;1;_FinalColorxAlpha;0;Meta Pass;1;Override Baked GI;0;Extra Pre Pass;0;DOTS Instancing;0;Tessellation;0;  Phong;0;  Strength;0.5,False,-1;  Type;0;  Tess;16,False,-1;  Min;10,False,-1;  Max;25,False,-1;  Edge Length;16,False,-1;  Max Displacement;25,False,-1;Vertex Position,InvertActionOnDeselection;1;0;6;False;True;True;True;True;True;False;;False;0
...
WireConnection;317;6;324;0
ASEEND*/
//CHKSM=BE3BC86E1D935E2E8FBE985047F510A34D259C03